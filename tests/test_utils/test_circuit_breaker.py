...
class TestCircuitBreaker:
    ...
    def test_half_open_recovery(self):
        ...
        mock_func = Mock(
            side_effect=[Exception("Error"), Exception("Error"), "success"]  # Success after timeout
        )
    ...
    def test_specific_exception_type(self):
        ...
        breaker = CircuitBreaker(failure_threshold=2, timeout=1, expected_exception=ValueError)
